...
export interface ICourseRegistrationRepository {
  ...
  remove(userId: string, courseId: string, versionId: string, session?: ClientSession): Promise<void>;
  deleteRegistrationByVersionId(versionId: string, session?: ClientSession): Promise<void>;
