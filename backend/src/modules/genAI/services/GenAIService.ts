      ...
      try {
        ...
        for (const currentSegmentId of jobState.segmentMap) {
          ...
          const createdVideoItem = await this.itemService.createItem(
            (jobState.parameters as UploadParameters).versionId.toString(),
            (jobState.parameters as UploadParameters).moduleId.toString(),
            (jobState.parameters as UploadParameters).sectionId.toString(),
            videoItemBody,
          );
