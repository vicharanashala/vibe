...
export interface HpActivity {
  ...
  // Stats
  stats: {
    // to track submission stats for this activity, updated by a scheduled job that runs every hour
...
export interface HpActivitySubmission {
  ...
  review: {
    // populated when status is APPROVED, REJECTED or REVERTED
