...
const assignmentsData: { id: number; title: string; course: string; dueDate: string; status: "Pending" | "In Progress" | "Completed"; grade: string }[] = [
  ...
  { id: 4, title: "English Literature", course: "Literature", dueDate: "2023-12-18", status: "Pending", grade: "B+" },
  { id: 5, title: "Computer Science Assignment", course: "Programming", dueDate: "2023-12-22", status: "In Progress", grade: "A" },
  { id: 6, title: "Chemistry Lab Report", course: "Chemistry", dueDate: "2023-12-28", status: "Completed", grade: "A-" },
  { id: 7, title: "Geography Presentation", course: "Geography", dueDate: "2023-12-30", status: "Pending", grade: "B-" },
  { id: 8, title: "Art Project", course: "Art", dueDate: "2023-12-29", status: "In Progress", grade: "A+" },
];
      ...
      <div className="max-w-4xl mx-auto">
        {assignments.length > 0 ? (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4 p-4 bg-white rounded-lg border border-gray-200 font-semibold text-gray-800">
