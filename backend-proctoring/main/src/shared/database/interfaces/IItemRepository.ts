import { IBaseItem, IVideoDetails, IQuizDetails, IBlogDetails } from "shared/interfaces/IUser";

export interface IItemRepository {
    createItem(item: IBaseItem): Promise<IBaseItem | null>;
    readItem(itemId: string): Promise<IBaseItem | null>;
    updateItem(itemId: string, item: Partial<IBaseItem>): Promise<IBaseItem | null>;
