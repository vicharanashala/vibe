...
const ItemContainer = forwardRef<ItemContainerRef, ItemContainerProps>(({ item, doGesture, onNext, onPrevVideo, isProgressUpdating, attemptId, setQuizPassed, setAttemptId, rewindVid, pauseVid, displayNextLesson}, ref) => {
