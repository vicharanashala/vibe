...
export function useInvites(): {
  ...
  const getInvites = useCallback(async (): Promise<any> => {
    setLoading(true);
    setError(null);
...
export function useGetPendingRegistrations(instructorId: string): {
  ...
  return {
    data: Array.isArray(result?.data) ? result?.data : EMPTY_ARRAY,
    isLoading: result.isLoading,
...
export function useGetPendingStudentRegistrations(studentId: string): {
  ...
  return {
    data: Array.isArray(result?.data) ? result?.data as PendingStudentRegistrationNotification[] : EMPTY_ARRAY,
    isLoading: result.isLoading,
...
export function useGetRejectedStudentRegistrations(studentId: string): {
  ...
  return {
    data: Array.isArray(result?.data) ? result?.data as RejectedStudentRegistrationNotification[] : EMPTY_ARRAY,
    isLoading: result.isLoading,
