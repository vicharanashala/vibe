...
//////////////////////////  Course Structrure Re-order hooks  ///////////////////////////

// PUT /courses/versions/{versionId}/modules/{moduleId}/move 

type MoveModuleBody = components['schemas']['MoveModuleBody'];
type MoveModuleResponse = components['schemas']['ModuleDataResponse'];
type MoveModulePathParams = operations['ModuleController.move']['parameters']['path'];

export function useMoveCourseModules(): {
  mutate: (variables: { params: MoveModulePathParams, body: MoveModuleBody }) => void,
  mutateAsync: (variables: { params: MoveModulePathParams, body: MoveModuleBody}) => Promise<MoveModuleResponse>,
  data: MoveModuleResponse | undefined,
  error: string | null,
  isPending: boolean,
  isSuccess: boolean,
  isError: boolean,
  ...
  return {
    ...result,
    error: result.error ? (result.error.message || 'Failed to move module') : null
  };
}

// PUT /courses/versions/{versionId}/modules/{moduleId}/sections/{sectionId}/move 

type MoveSectionBody = components['schemas']['MoveSectionBody'];
type MoveSectionResponse = components['schemas']['SectionDataResponse'];
type MoveSectionPathParams = operations['SectionController.move']['parameters']['path'];

export function useMoveCourseSection(): {
  mutate: (variables: { params: MoveSectionPathParams, body: MoveSectionBody }) => void,
  mutateAsync: (variables: { params: MoveSectionPathParams, body: MoveSectionBody}) => Promise<MoveSectionResponse>,
  data: MoveSectionResponse | undefined,
  error: string | null,
  isPending: boolean,
  isSuccess: boolean,
  isError: boolean,
  ...
  return {
    ...result,
    error: result.error ? (result.error.message || 'Failed to move section') : null
  };
}

// PUT /courses/versions/{versionId}/modules/{moduleId}/sections/{sectionId}/items/{itemId}/move

type MoveItemBody = components['schemas']['MoveItemBody'];
type MoveItemResponse = components['schemas']['ItemDataResponse'];
type MoveItemPathParams = operations['ItemController.move']['parameters']['path'];

export function useMoveCourseItem(): {
  mutate: (variables: { params: MoveItemPathParams, body: MoveItemBody }) => void,
  mutateAsync: (variables: { params: MoveItemPathParams, body: MoveItemBody}) => Promise<MoveItemResponse>,
  data: MoveItemResponse | undefined,
  error: string | null,
  isPending: boolean,
  isSuccess: boolean,
  isError: boolean,
  ...
  return {
    ...result,
    error: result.error ? (result.error.message || 'Failed to move course item') : null
  };
}
