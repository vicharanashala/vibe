                                    ...
                                    <div className="flex items-center gap-2 flex-shrink-0">
                                        ...
                                        {status === 'SUBMITTED' ? (
                                            ...
                                            <>
                                                ...
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <Badge variant="outline" className="text-sm text-muted-foreground cursor-default">
                                                            Activity Points: {sub.hp?.baseHp || 0}
                                                        </Badge>
                                                    </TooltipTrigger>
                                                    <TooltipContent className="max-w-[240px] text-xs">
                                                            {stats?.reward?.type === "PERCENTAGE"
                                                                ? `Type: Percentage
                                                        Value: ${stats.reward.value}%
                                                        Calculation: ${stats.reward.value}% of current HP (${totalCurrentHp})`
                                                                : `Type: Absolute
                                                        Value: ${stats?.reward?.value ?? sub.hp?.baseHp ?? 0}`
                                                            }
                                                    </TooltipContent>
                                                </Tooltip>
                                            </>
