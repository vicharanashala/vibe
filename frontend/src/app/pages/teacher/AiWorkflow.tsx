...
import { ArrowLeft, ArrowRight, CheckCircle, Clock, Edit, FileText, HelpCircle, ListChecks, Loader2, MessageSquareText, PauseCircle, Pencil, Plus, RefreshCw, Save, Scissors,Settings, Sparkles, Trash2, Upload, UploadCloud, X, XCircle, Zap, Info } from 'lucide-react';
...
const SegmentationView = ({
  ...
  const [editModalOpen, setEditModalOpen] = useState(false);
  // Store segment boundaries as seconds for correct math and comparisons
