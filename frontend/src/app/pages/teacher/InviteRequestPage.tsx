...
//                     <TableHead className="text-lg font-semibold py-2 w-1/4">Name</TableHead>
//                     <TableHead className="text-lg font-semibold py-2 w-1/3">Email</TableHead>
//                     <TableHead className="text-lg font-semibold py-2 w-1/6">Status</TableHead>
//                     <TableHead className="text-lg font-semibold py-2 w-1/4">Actions</TableHead>
//                   </TableRow>
//                 </TableHeader>
//                 <TableBody>
//                   {filteredUsers.map((user) => (
//                     <TableRow key={user.id} className="hover:bg-muted/50 transition-all duration-200">
//                       <TableCell className="py-2 text-lg font-medium">{user.name}</TableCell>
//                       <TableCell className="py-2 text-base">{user.email}</TableCell>
...
//                         </Badge>
//                       </TableCell>
//                       <TableCell className="py-2 flex gap-3">
//                         <Button
//                           variant="outline"
//                           size="sm"
//                           onClick={() => handleViewDetails(user)}
//                           className="flex items-center gap-2 text-primary border-primary/50 hover:bg-primary/10 transition-all duration-300 px-1 py-2"
//                         >
