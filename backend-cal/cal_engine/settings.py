"""
Django settings for cal_engine project.
...
WSGI_APPLICATION = 'cal_engine.wsgi.application'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),  # Adjust token expiry as needed
